...
public class RouteServiceImpl implements RouteService {
    ...
    public RouteResponse createRoute(CreateRouteRequest request) {
        ...
        // =====================================================
        // DEACTIVATE PREVIOUS CURRENT ROUTE
        // =====================================================

        List<Route> previousCurrentRoutes =
                routeRepository.findAllByShipment_IdAndIsCurrentTrue(
                        shipmentId
                );

        for (Route previousRoute : previousCurrentRoutes) {

            previousRoute.setIsCurrent(false);

            routeRepository.save(previousRoute);

            log.info(
                    "Previous route {} marked as not current",
                    previousRoute.getId()
            );
        }
        ...
        Route route = Route.builder()
                ...
                // New route is the current route
                .isCurrent(true)
        ...
        log.info(
                "New current route created successfully. Route ID: {}",
                savedRoute.getId()
        );
    ...
    public RouteResponse getRouteByShipment(
        ...
        log.info(
                "Getting current route for shipment: {}",
                shipmentId
        );

        Route route = routeRepository
                .findByShipment_IdAndIsCurrentTrue(shipmentId)
                .orElseThrow(() ->
                        new RuntimeException(
                                "Current route not found for shipment: "
                                        + shipmentId
                        )
                );
    ...
    public List<RouteResponse> getRouteHistory(
        ...
        log.info(
                "Getting route history for shipment: {}",
                shipmentId
        );

        List<Route> routes =
                routeRepository
                        .findByShipment_IdOrderByCreatedAtAsc(
                                shipmentId
                        );
