...
public class RouteController {
    ...
    /**
     * Get ONLY the current route for a shipment.
     */
    ...
    /**
     * Get all routes created for a shipment,
     ...
     *
     * Only OPERATOR, LOGISTICS_OPERATOR or ADMINISTRATOR
     */
